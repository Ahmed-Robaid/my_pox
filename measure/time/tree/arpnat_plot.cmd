set term pdf
set output "tree_time_arpnat.pdf"
set xlabel "host #"
...
plot "tree_l2.dat" using 1:2 title 'legacy' with linespoint ls 1, \
     "tree_arpnat.dat" using 1:2 title 'arpnat' with linespoint ls 2,\
     "tree_arpresp.dat" using 1:2 title 'arp_responder' with linespoint ls 3,\
     "tree_arprespsafe.dat" using 1:2 title 'safe arp_responder' with linespoint ls 5
